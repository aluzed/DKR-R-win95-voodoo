...
int main(int argc, char** argv) {
    ...
    try {
        ...
        p.inspector=std::make_unique<Inspector>(app.device.get(),app.swapChain.get(),dx?UserConfiguration::GraphicsAPI::D3D12:UserConfiguration::GraphicsAPI::Vulkan,window);
