...
/* `g_title_intro_tail_gate` is NOT declared here: E07-S03 hoisted it, with
   `RdramAddress`, above the `DKR_RUNTIME_HAS_RT64` guard. Both are portable, and
   `dkr_title_intro_audio_tail` needs them on a target that has no RT64. */
